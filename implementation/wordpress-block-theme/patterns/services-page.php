 ...
 * Slug: wp-growth-studio/services-page
 * Categories: text
 */
?>
...
<div class="wp-block-group" style="padding-top:3rem;padding-bottom:4rem">
	...
	<!-- /wp:paragraph -->
	<!-- wp:heading {"level":1} -->
	<h1 class="wp-block-heading">WordPress launch package for local service businesses.</h1>
	<!-- /wp:heading -->
	<!-- wp:paragraph {"fontSize":"large"} -->
	<p class="has-large-font-size">A focused build that covers the homepage, core pages, SEO blog foundation, forms, analytics, performance basics, and launch readiness.</p>
	<!-- /wp:paragraph -->
	...
	<!-- /wp:columns -->
	<!-- wp:buttons -->
	<div class="wp-block-buttons"><!-- wp:button --><div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/contact/">Book a consultation</a></div><!-- /wp:button --><!-- wp:button {"className":"is-style-outline"} --><div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/blog/">Browse articles</a></div><!-- /wp:button --></div>
	<!-- /wp:buttons -->
</div>
<!-- /wp:group -->
